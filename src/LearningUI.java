...
public class LearningUI extends JFrame implements ActionListener, KeyListener 
{
	...
	public LearningUI(User user){
		...
		setIconImage(getToolkit().getImage("D:\\SRU ACADEMIC\\SRU SEM-6\\Mini Project\\Keystroke-Biometrics-Identification-System-master\\Keystroke Identification\\Images\\Home.gif"));
		setResizable(false);
		setLayout(null);
