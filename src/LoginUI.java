...
public class LoginUI extends JFrame implements ActionListener, KeyListener 
{
	...
	public LoginUI(){
		...
		setIconImage(getToolkit().getImage("D:\\SRU ACADEMIC\\SRU SEM-6\\Mini Project\\Keystroke-Biometrics-Identification-System-master\\Keystroke Identification\\Images\\Keys.gif"));
				...
				if(user == null)
					...
					if(verifyUserCredentials(user))
					{
						...
						if(verified ==3) {
							...
							dispose();
							Userpasswords user1=new Userpasswords(userName);
